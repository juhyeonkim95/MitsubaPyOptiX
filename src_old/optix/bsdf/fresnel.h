...
//-----------------------------------------------------------------------
RT_FUNCTION float ConductorReflectance(float eta, float k, float cosThetaI)
//-----------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------
RT_FUNCTION float3 ConductorReflectance(const float3 &eta, const float3 &k, float cosThetaI)
//-----------------------------------------------------------------------
{
    return make_float3(
...
//-----------------------------------------------------------------------
RT_FUNCTION float DielectricReflectance(float eta, float cosThetaI, float &cosThetaT)
//-----------------------------------------------------------------------
{
    if (cosThetaI < 0.0f) {
        eta = 1.0f/eta;
...
//-----------------------------------------------------------------------
RT_FUNCTION float DielectricReflectance(float eta, float cosThetaI)
//-----------------------------------------------------------------------
{
    float cosThetaT;
...
//-----------------------------------------------------------------------
RT_FUNCTION float DiffuseFresnel(float eta)
//-----------------------------------------------------------------------
{
    float result;
    if(eta < 1.0f){
