...
class QTable:
    ...
    def update_pdf(self, context, epsilon, cdf=False, quad_tree_update_type='gpu'):
    ...
    def register_empty_context(context):
        ...
        # directional, quadtree
        #context['quad_tree_index_array'] = Buffer.empty((0, 0), buffer_type='i', drop_last_dim=False)
        #context['quad_tree_rank_array'] = Buffer.empty((0, 0), buffer_type='i', drop_last_dim=False)
